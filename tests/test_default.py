...
def test_default():
    ...
    structured_data.moduleAttributes = JsonModuleAttributes(**structured_data.moduleAttributes)
    structured_data.moduleAttributes.moduleAddress = Address(structured_data.moduleAttributes.moduleAddress)
    structured_data.moduleAttributes.validatorAttributes = JsonValidatorAttributes(**structured_data.moduleAttributes.validatorAttributes)
    structured_data.moduleAttributes.executorAttributes = JsonExecutorAttributes(**structured_data.moduleAttributes.executorAttributes)
